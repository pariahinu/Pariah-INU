...
describe('migrate-imports.js', function () {
  ...
  it('replaces import paths in a file', async function () {
    const source = `
import '@Pariah-INU/contracts/math/Math.sol';
import '@Pariah-INU/contracts-upgradeable/math/MathUpgradeable.sol';
    `;
    const expected = `
import '@Pariah-INU/contracts/utils/math/Math.sol';
import '@Pariah-INU/contracts-upgradeable/utils/math/MathUpgradeable.sol';
    `;
