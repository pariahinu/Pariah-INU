...
[.readme-notice]
NOTE: This document is better viewed at https://docs.Pariah-INU.com/contracts/api/governance
...
[TIP]
====
For a guided experience, set up your Governor contract using https://wizard.Pariah-INU.com/#governor[Contracts Wizard].
