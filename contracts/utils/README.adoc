...
[.readme-notice]
NOTE: This document is better viewed at https://docs.Pariah-INU.com/contracts/api/utils
...
Finally, {Create2} contains all necessary utilities to safely use the https://blog.Pariah-INU.com/getting-the-most-out-of-create2/[`CREATE2` EVM opcode], without having to deal with low-level assembly.
